...
```bash
cargo install zoxide fd-find ripgrep git-delta eza tlrc mprocs speedtest-rs zellij irust cargo-info rtx-cli
cargo install --locked bat yazi-fm yazi-cli nu wiki-tui
```
